...
function LandingPage() {
	...
	return (
		<div className="w-screen h-screen flex flex-col lg:flex-row justify-center items-center p-3 lg:p-6 bg-blue-500 	overflow-hidden">
			<div className="w-full lg:w-2/3 2xl:w-2/3 relative flex flex-col justify-between items-center gap-6">
				<div className='flex  flex-col justify-center w-full h-4/5 items-center'>
					<img
						src={Jmclogo}
						alt=""
						className="absolute h-40 md:h-60 lg:h-96 md:w-60 lg:w-96 opacity-10 2xl:w-1/2 2xl:h-4/5"
					/>
					<img
						src={Jamal}
						alt=""
			...
			<div className="flex flex-col justify-items-center items-center rounded-lg w-full lg:w-1/3 h-full">
				<div className="grid grid-cols-2 gap-8 lg:gap-8 w-full mt-36 lg:mb-20 mx-auto 2xl:grid-cols-3 2xl:mt-96">
					<button
