...
return(
        <div>
         ...
         <div className='mt-6 grid grid-cols-4 w-auto text-white bg-emerald-500'>
                     <div className="font-bold border border-black text-center py-3">Particulars</div>
                         <div className="font-bold border border-black text-center py-3">Pending</div>
                         <div className="font-bold border border-black text-center py-3">Completed</div>
                         <div className="font-bold border border-black text-center py-3">Total</div>
         </div>
         ...
         <div className={`grid grid-cols-4 bg-emerald-200`}>
                     <div className="font-bold border border-black text-center py-3">Deeniyath Men</div>
                         <div className="font-bold border border-black text-center py-3">{data.damCount}</div>
                         <div className="font-bold border border-black text-center py-3">{data.aCompleted}</div>
                         <div className="font-bold border border-black text-center py-3">{data.damTotal}</div>
         </div>
         <div className={`grid grid-cols-4 bg-emerald-200`}>
                     <div className="font-bold border border-black text-center py-3">Deeniyath Women</div>
                         <div className="font-bold border border-black text-center py-3">{data.dwCount}</div>
                         <div className="font-bold border border-black text-center py-3">{data.wCompleted}</div>
                         <div className="font-bold border border-black text-center py-3">{data.dwTotal}</div>
         </div>
         <div className={`grid grid-cols-4 bg-emerald-200`}>
                     <div className="font-bold border border-black text-center py-3">Moral Men</div>
         ...
         <div className={`grid grid-cols-4 bg-emerald-200`}>
                     <div className="font-bold border border-black text-center py-3">Moral Women</div>
                         ...
                         <div className="font-bold border border-black text-center py-3">{data.mwCompleted}</div>
                         <div className="font-bold border border-black text-center py-3">{data.mwTotal}</div>
         </div>
         <div className={`grid grid-cols-4 bg-emerald-200`}>
