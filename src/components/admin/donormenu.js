        ...
        <div>
            <div className='grid grid-cols-3 gap-10 ml-3 mr-3 font-bold'>
                ...
                <button
                    ...
                    className="px-4 py-12  ml-48 -mr-48 bg-cyan-500 text-2xl text-white mt-16 hover:bg-black rounded-lg"
                >
                    Scholarship Received
                </button>
                <button
                    onClick={() => navigate('/admin/getLetter')}
                    className="px-4 py-9 -mr-52 ml-52   bg-cyan-500 text-2xl text-white mt-16 hover:bg-black rounded-lg"
                >
                    Gratitude Note
                </button>
            </div>
