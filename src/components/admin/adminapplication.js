                    ...
                    rusers.map((users) => {
                        return (
                            <div key={users.registerNo} className="grid grid-cols-6 w-auto bg-amber-200 p-4 border border-white gap-1 text-center">
                                <div className="font-bold border border-white text-center">{users.fresherOrRenewal}</div>
                                <div className="font-bold border border-white text-center">{users.dept}</div>
                                <div className="font-bold border border-white text-center">{users.registerNo}</div>
                                <div className="font-bold border border-white text-center">{users.name}</div>
                                <div className="font-bold border border-white text-center">
                                    <button
                                        type="submit"
                                        className="bg-blue-500 text-white py-1 px-3  hover:bg-black rounded-lg mt-1"
